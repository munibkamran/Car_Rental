    ...
    <Link to="/contact" className="text-gray-600 hover:text-blue-500">Contact</Link>
        ...
        <button className="text-zinc-800 text-3xl md:hidden ml-auto" onClick={toggleMenu}>
         ...
         <ul className={`flex flex-col gap-y-9 bg-white/15 rounded-xl backdrop-blur-lg p-13 md:hidden position absolute top-30 -left-full transform -translate-x-1/2 transition-all duration-500 ${ShowMenu ? 'left-1/2' : null}`}>
          <li><a href="#" className="text-blue-600 font-medium hover:text-blue-500">Home</a><hr className='text-gray-500'/></li>
          <li><a href="#" className="text-blue-600 font-medium hover:text-blue-500">Cars</a><hr className='text-gray-500'/></li>
          <li><a href="#" className="text-blue-600 font-medium hover:text-blue-500">About</a><hr className='text-gray-500'/></li>
          <li><a href="#" className="text-blue-600 font-medium hover:text-blue-500">Contact</a><hr className='text-gray-500'/></li>
